...
Originally developed by Eternal Tunnel Corp, this collection of projects for launching AI-powered tokens on Base (Ethereum L2) using the WoW protocol has been open sourced and released to the public domain. Eternal Tunnel Corp has ceased all development and maintenance of these projects, making them freely available for anyone to fork, modify, and build upon.
...
Eternal Tunnel Corp no longer maintains these projects. The community is encouraged to:
...
These projects were originally developed by Eternal Tunnel Corp but are no longer maintained by the company. They are provided as-is without warranty, support, or ongoing development. Users who choose to fork and build upon this code are fully responsible for:
...
These projects were originally developed by Eternal Tunnel Corp as part of the Dream ecosystem. Following the company's decision to cease operations on these projects, all code has been open sourced and the Dream brand and intellectual property have been released to the public domain under CC0.
...
The official Telegram account has been deprecated as all operations have been ceased and Eternal Tunnel Corp is no longer responsible for the project. A community run Telegram account is available [here](https://t.me/+71IRhRJHS0ZhYjg0)
