...
Originally developed by Eternal Tunnel Corp, this marketing website for Dream Computer - a platform for launching AI agents and tokens on Base - has been open sourced and released to the public domain. Eternal Tunnel Corp has ceased development and maintenance of this project.
...
- [Telegram](https://t.me/DreamcoinsChat)
...
This project was originally developed by Eternal Tunnel Corp but is no longer maintained. It is provided as-is for the community to build upon.

## Contributing

This project is no longer actively maintained by Eternal Tunnel Corp. The codebase has been open sourced for the community to fork, modify, and build upon freely.