export const WOW_TOKEN_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "totalEthLiquidity", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "totalTokenLiquidity", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "lpPositionId", type: "uint256" },
      { indexed: false, internalType: "enum IWow.MarketType", name: "marketType", type: "uint8" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "orderReferrer", type: "address" },
      ...
      { indexed: false, internalType: "uint256", name: "buyerTokenBalance", type: "uint256" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "factoryAddress", type: "address" },
      ...
      { indexed: false, internalType: "address", name: "bondingCurve", type: "address" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "orderReferrer", type: "address" },
      { indexed: false, internalType: "address", name: "protocolFeeRecipient", type: "address" },
      { indexed: false, internalType: "uint256", name: "tokenCreatorFee", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "platformReferrerFee", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "orderReferrerFee", type: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "sellerTokenBalance", type: "uint256" },
      { indexed: false, internalType: "string", name: "comment", type: "string" },
      { indexed: false, internalType: "enum IWow.MarketType", name: "marketType", type: "uint8" },
    ],
    name: "WowTokenSell",
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "fromTokenBalance", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "toTokenBalance", type: "uint256" },
